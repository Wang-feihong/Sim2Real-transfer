...
let OptoForceGoal = require('./OptoForceGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class OptoForceActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = OptoForceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OptoForceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = OptoForceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new OptoForceGoal()
    }
...
module.exports = OptoForceActionGoal;
