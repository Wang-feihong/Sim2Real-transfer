...
if("TRUE" STREQUAL "TRUE")
  set(optoforce_SOURCE_PREFIX /home/wfh/catkin_ws/src/optoforce/optoforce)
  set(optoforce_DEVEL_PREFIX /home/wfh/catkin_ws/devel)
  ...
  set(optoforce_INSTALL_PREFIX /home/wfh/catkin_ws/install)
...
if(NOT "/home/wfh/catkin_ws/src/optoforce/optoforce/include " STREQUAL " ")
  set(optoforce_INCLUDE_DIRS "")
  set(_include_dirs "/home/wfh/catkin_ws/src/optoforce/optoforce/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'optoforce' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'optoforce' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wfh/catkin_ws/src/optoforce/optoforce/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT optoforce_NUM_DUMMY_TARGETS)
      set(optoforce_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::optoforce::wrapped-linker-option${optoforce_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR optoforce_NUM_DUMMY_TARGETS "${optoforce_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::optoforce::wrapped-linker-option${optoforce_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND optoforce_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${optoforce_dep}_FOUND)
      find_package(${optoforce_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${optoforce_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(optoforce_EXPORTED_TARGETS ${${optoforce_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "my-extras.cmake")
