...
"""autogenerated by genpy from optoforce_ros/OptoForceActionResult.msg. Do not edit."""
import codecs
import sys
...
class OptoForceActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "optoforce_ros/OptoForceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','optoforce_ros/OptoForceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OptoForceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = optoforce_ros.msg.OptoForceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = optoforce_ros.msg.OptoForceResult()
