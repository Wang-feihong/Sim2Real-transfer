...
"""autogenerated by genpy from optoforce_ros/OptoForceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class OptoForceActionFeedback(genpy.Message):
  _md5sum = "6e286a9f842b40c233bfd6d839e63502"
  _type = "optoforce_ros/OptoForceActionFeedback"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','optoforce_ros/OptoForceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OptoForceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = optoforce_ros.msg.OptoForceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = optoforce_ros.msg.OptoForceFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.feedback.wrench_lst)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.wrench_lst:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.feedback.wrench_lst.append(val1)
      return self
